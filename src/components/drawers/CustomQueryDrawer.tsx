...
interface CustomQueryDrawerProps {
  open: boolean;
  onClose: () => void;
  loading: boolean;
  tests: Test[];
...
const CustomQueryDrawer: React.FC<CustomQueryDrawerProps> = ({
  open,
  onClose,
  loading,
  tests,
                  ...
                  return (
                    ...
                    >
                      <AccordionSummary
                        ...
                        sx={{
                          bgcolor: selection.isSelected ? "#f3e5f5" : "#f8f9fa",
                          borderRadius: "6px",
                              ...
                              >
                                ...
                                <AccordionDetails sx={{ pt: 1, pb: 1.5 }}>
                                  ...
                                  <Box>
                                    ...
                                    >
                                      Build expression using channels and
                                      operators (+, -, *, /, parentheses)
                                    </Typography>
                                    <TextField
                                      fullWidth
                                      size="small"
                                      placeholder="e.g., 10104000 + 10104001 - 10104002"
                                      value={config.channelExpression}
                                      onChange={(e) =>
                                        onChannelExpressionChange(
                                          selection.testName,
                                          config.configName,
...
export default CustomQueryDrawer;
