    ...
    >
      <Box sx={{ width: "100%", p: 2 }}>
        ...
        <Box sx={{ mb: 2, p: 1, bgcolor: "#e3f2fd", borderRadius: 1 }}>
          <Typography
            variant="caption"
            sx={{ fontSize: "0.7rem", color: "#1976d2" }}
          >
            💡 <strong>Custom Query Tab</strong> is available in the original
            code (asit.tsx). To add it here, we need to create CustomQueryDrawer
            component (~300 lines).
          </Typography>
        </Box>
