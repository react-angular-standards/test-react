        ...
        <div className='mb-5'>
          ...
          <DragDropContext onDragEnd={prop.handleDragEnd}>
            ...
            <div className='lt-border rounded p-3 mb-3 transition'>
              <span className='text-muted'>
                ...
                <input
                  ...
                  type='text'
                  value={prop.primaryChannelGroup.name}
                  onChange={(e) => {
              ...
              <Droppable
                ...
                {(provided) => (
                  <div
                    ...
                    {prop.primaryChannelGroup.channels.map((channel, index) => (
                      <Draggable
                    ...
                    {prop.primaryChannelGroup.channels.length === 0 && (
            ...
            <div className='mt-4'>
              ...
              {prop.secondaryChannelGroups.map((group, index) => (
                <Droppable
                  key={group.id}
              ...
              {prop.secondaryChannelGroups.length === 0 && (
