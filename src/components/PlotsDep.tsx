...
interface PlotContextType {
  ...
  setChannelList: React.Dispatch<React.SetStateAction<number[]>>;
  setAvailableChannels: React.Dispatch<React.SetStateAction<number[]>>;
  ...
  setChartOptions: React.Dispatch<React.SetStateAction<ChartConfig[]>>;
                ...
                >
                  {chartOptions.map((chart) => (
                    <div key={chart.id} className="chart-container">
                      ...
                      >
                        <CanvasJSChart
                          ref={(ref: CanvasJSChart | null) => { chartRefs.current[chart.id] = ref; }}
